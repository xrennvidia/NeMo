...
python ~/NeMo/examples/nlp/machine_translation/create_tarred_parallel_dataset.py \
    ...
    --tgt_fname "${work_dir}/train/autoregressive_labels_wprefix.txt" \
    --out_dir "${work_dir}/for_upload/train_autoregressive_wprefix_tarred_${tokens_in_batch}" \
    ...
    --decoder_tokenizer_model "${work_dir}/for_upload/autoregressive_labels_wprefix.BPE.18.model" \
