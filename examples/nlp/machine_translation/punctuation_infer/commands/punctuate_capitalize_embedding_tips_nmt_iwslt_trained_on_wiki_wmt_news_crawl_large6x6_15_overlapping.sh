...
pred_labels="${output_dir}/embedding_tips_large6x6_15_overlapping_labels.txt"
python punctuate_capitalize_nmt.py \
    --input_text "${work_dir}/text_iwslt_en_text.txt" \
    --output_text "${output_dir}/embedding_tips_large6x6_15_overlapping_text.txt" \
...
python compute_metrics.py \
    ...
    --output "${output_dir}/embedding_tips_large6x6_15_overlapping_scores.json" \
