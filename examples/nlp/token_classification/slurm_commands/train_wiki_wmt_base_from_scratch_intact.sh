...
EXPNAME="evelina_wiki_wmt_intact_base_lr3e-5_steps400k_from_scratch_bs160k"

# Mounts
SLURM_ACCOUNT='ent_aiapps'
USERID='apeganov'
LUSTRE_ACCOUNT_PREFIX=/gpfs/fs1/projects/${SLURM_ACCOUNT}
DATA="${LUSTRE_ACCOUNT_PREFIX}/datasets/data/punctuation_capitalization/wiki_wmt_simplest_intact_21.01.2022"
