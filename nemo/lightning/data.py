...
def setup_microbatch_calculator(
    ...
    if MCORE_MB_CALCULATOR:
        ...
        if _GLOBAL_NUM_MICROBATCHES_CALCULATOR is None:
            ...
            print(f"setup_microbatch_calculator: rank: {torch.distributed.get_rank()}, global_rank: {init_global_rank}, global_batch_size: {get_current_global_batch_size()}, global_batch_size_split: {global_batch_size_split}, micro_batch_size: {get_micro_batch_size()}, num_microbatches: {get_num_microbatches()}")
        else:
