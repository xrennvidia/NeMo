...
def gen_pred_from_speech_segments(speech_segments, dur=None, prob=None, shift_length_in_sec=0.01):
    """
    ...
    if prob:
        ...
        if dur:
            pred = np.zeros(int(dur/shift_length_in_sec))
