...
from nemo.collections.nlp.data.glue_benchmark.text2text_ptune_dataset import TextToTextPTuneDataset
...
class MegatronT5PTuneModel(NLPModel):
    ...
    def get_loss(self, batch):
        ...
        input_embeds = self.embed_input(tokens_enc)
    ...
    def build_train_valid_test_datasets(self, test_only=False):
        ...
        self._test_ds = TextToTextPTuneDataset(
        ...
        self._train_ds = TextToTextPTuneDataset(
        ...
        self._validation_ds = TextToTextPTuneDataset(
